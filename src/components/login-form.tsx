          ...
          <motion.div variants={itemVariants}>
            <Field>
              <div className="flex items-center justify-between mb-1">
                ...
                {/* Hard navigation — bypasses Next.js router so nothing can intercept it */}
                <a
                  href="/forgot-password"
                  className="text-[12px] text-[var(--accent)] hover:text-[var(--accent-bright)] underline-offset-4 hover:underline transition-colors"
                >
                  Forgot password?
                </a>
              </div>
